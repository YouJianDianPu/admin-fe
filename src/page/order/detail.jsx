/*
* @Author: YouJDP
* @Date:   2018-04-04 20:03:01
* @Last Modified by:   YouJDP
* @Last Modified time: 2018-04-05 23:32:40
*/
                ...
                <div className="row">
                    <div className="form-wrap col-lg-12">
                        <div className="form-horizontal">
                            ...
                            <div className="form-group">
                                <label htmlFor="subtitle" className="col-md-2 control-label">取餐人：</label>
                                <div className="col-md-5">
                                    ...
                                    <p type="text" className="form-control-static">
                                        {this.state.orderInfo.statusDesc}
                                        {
                                            this.state.orderInfo.status == 20 
                                                ? <a className="btn btn-sm btn-default btn-send-goods" onClick={this.onSendGoods}>可取餐</a>
                                                : null
                                        }   
